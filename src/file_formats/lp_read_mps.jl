...
This function parses a given MPS (Mathematical Programming System) formatted string and converts it into an 
`LPProblem` struct, representing a Linear Programming (LP) problem in Julia.
